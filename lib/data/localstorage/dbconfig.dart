class DatabaseConfig {
  ...
  static const createTableQueries = [
    ...
    'CREATE TABLE IF NOT EXISTS User (id INTEGER PRIMARY KEY, walletaddress TEXT, btctestaddress TEXT, btcmainaddress TEXT, seed TEXT, language TEXT,publictoken TEXT,uid TEXT,googlefitenable INTEGER)',
