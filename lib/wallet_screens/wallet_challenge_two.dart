...
class WalletChallengeTwo extends StatefulWidget {
  const WalletChallengeTwo({Key key}) : super(key: key);

  @override
  _WalletChallengeTwoState createState() => _WalletChallengeTwoState();
}

class _WalletChallengeTwoState extends State<WalletChallengeTwo> {
